...
const GetProductsInCartByUserId = async(userId)=>{
    return await api.get(`ProductInCart/GetProductsInCartByUserId?userId=${userId}`).then(res => res.data);
}
...
return await api.post('ProductInCart', produc).then(res => res.data);
}
...
export {GetProductsInCartByUserId,GetCartById, AddProductToCart,RemoveProduct, UpdateProduct}
